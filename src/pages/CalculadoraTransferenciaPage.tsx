...
export default function CalculadoraTransferenciaPage() {
  return (
    <HelmetProvider>
      <SEO
        title="Estimador de Costos de Transferencia de Auto | Calculadora 2026"
        description="Calculá el costo exacto de transferir tu auto. Incluye honorarios, sellado y gastos registrales. Actualizado 2026."
        keywords="estimador de costos transferencia auto, calculadora transferencia auto, costo transferencia vehiculo argentina, cuanto cuesta transferir un auto, simulador transferencia automotor, aranceles dnrpa 2026, sellado transferencia auto"
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-[#141416] border border-[#2a2a2c] rounded-xl p-6">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <Link to="/guias/que-documentos-necesito-para-transferir-un-auto" className="block p-4 bg-[#0B0B0D] border border-[#2a2a2c] rounded-lg hover:border-[#C8A161]/50 transition-colors group">
                ...
                <Link to="/guias/como-calcular-precio-auto-usado-argentina" className="block p-4 bg-[#0B0B0D] border border-[#2a2a2c] rounded-lg hover:border-[#C8A161]/50 transition-colors group">
