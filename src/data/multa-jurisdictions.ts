...
export const JURISDICCIONES_MULTA: JurisdiccionMulta[] = [
  ...
  { value: 'pba',            label: 'Provincia de Buenos Aires', sub: 'Buenos Aires',          slug: 'multas-provincia-buenos-aires',  manualUrl: null, metaTitle: 'Multas Provincia de Buenos Aires por Patente — InfraccionesBA | carChecking', metaDescription: '¿Tenés multas en la Provincia de Buenos Aires? Consultá infracciones por patente en InfraccionesBA — cubre los 135 municipios bonaerenses, conurbano e interior. Gratis.' },
