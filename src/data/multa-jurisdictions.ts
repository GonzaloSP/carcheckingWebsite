...
export const JURISDICCIONES_MULTA: JurisdiccionMulta[] = [
  ...
  { value: 'pba',            label: 'Provincia de Buenos Aires', sub: 'Buenos Aires',          slug: 'multas-provincia-buenos-aires',  manualUrl: null, metaTitle: 'Multas Buenos Aires por Patente: Infracciones PBA | carChecking', metaDescription: 'Consultá multas e infracciones de la Provincia de Buenos Aires por patente. InfraccionesBA, los 135 municipios del conurbano e interior. Gratis, sin registro, al instante.' },
  ...
  { value: 'rosario',        label: 'Rosario',                   sub: 'Municipalidad',         slug: 'multas-rosario',                 manualUrl: 'https://www.rosario.gob.ar/gdm/patente.do?accion=ir', metaTitle: 'Multas en Rosario por Patente: Consultá Online Gratis | carChecking', metaDescription: 'Consultá fotomultas, Guardia Urbana y juzgados de tránsito de Rosario por patente o dominio, en segundos. Verificación en tiempo real del portal municipal. Gratis, sin registro.' },
