...
import { MULTAS_PBA_GUIDES, PBA_GUIDE_RELATED_LINKS } from '../data/multas-pba-guides';

const SLUG_TO_LABEL: Record<string, string> = {
  'como-consultar': 'Cómo consultar',
  'como-pagar': 'Cómo pagar',
  'deuda-patentes-arba': 'Deuda de patentes ARBA',
};

export default function MultasPBAGuidePage({ guide }: { guide: string }) {
  const content = guide ? MULTAS_PBA_GUIDES[guide] : undefined;
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-[#141416] border border-[#C8A161]/25 rounded-xl p-6 mb-10 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <div className="flex-1">
                <p className="text-sm font-semibold text-[#F4F1EC] mb-0.5">Consultá multas en Provincia de Buenos Aires ahora</p>
